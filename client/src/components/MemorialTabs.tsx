...
export default function MemorialTabs({
  ...
  return (
    <Tabs defaultValue="memories" className="w-full">
      <TabsList className="grid w-full grid-cols-3 lg:grid-cols-6 h-auto gap-2 p-2">
        <TabsTrigger value="memories" className="gap-2" data-testid="tab-memories">
          <Image className="w-4 h-4" />
          <span className="hidden sm:inline">Memories</span>
        </TabsTrigger>
        <TabsTrigger value="condolences" className="gap-2" data-testid="tab-condolences">
        ...
        <TabsTrigger value="fundraiser" className="gap-2" data-testid="tab-fundraiser">
      ...
      <TabsContent value="condolences" className="mt-6">
        {condolencesContent}
      </TabsContent>
