...
async function generateSticker() {
  ...
  fs.writeFileSync('attached_assets/generated_images/OpictuaryStickerSquare.png', buffer);
  console.log('Sticker generated successfully!');
  console.log('Saved to: attached_assets/generated_images/OpictuaryStickerSquare.png');
}
